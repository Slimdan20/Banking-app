    ...
    <div id="cards" className="mt-10 bg-gray-200 scroll-mt-20">
      ...
      <div className="mt-10 flex justify-between items-center mx-36">
        <Image
          ...
          width={600} 
          height={288} 
          className="rounded-4xl w-2/4 h-72" 
        />
        <p className="w-2/5 text-3xl">
          Link all your bank cards in one place — quick, simple, hassle-free.
        </p>
      </div>

      <Link href="/form">
        <button
          className="bg-black text-white mx-36 w-36 mt-12 mb-12 rounded-2xl h-12 cursor-pointer"
        >
          Link your card
        </button>
      </Link>
